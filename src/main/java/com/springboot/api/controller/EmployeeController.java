...
public class EmployeeController {
    ...
    // automatically the spring boot will get the implementation from the method in
    ...
    public ResponseEntity<Employee> updateEmployeeById(@PathVariable("employeeId") Long id, @RequestBody Employee employee) {
        return new ResponseEntity<Employee>(EmployeeService.updateEmployeeById(id, employee), HttpStatus.ACCEPTED);
    }

    // delete
    @RequestMapping(path = "{employeeId}", method = RequestMethod.DELETE)
    public void deleteEmployeesByid(@PathVariable("employeeId") Long id) {
